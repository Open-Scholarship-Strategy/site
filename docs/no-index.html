...
* Establish support structures (e.g., openLab, walk-in labs and support structures, makerspaces in the wider sense) that help to guide other individuals along the path towards Open Scholarship. This can include questions of how to publish, teach, learn and do research in the open, and what tools are available to use for these (Figures 1 and 2).
...
* Mandating [ORCID](https://orcid.org/) for researchers across all research outputs to help assist in the persistent identification of authors across the entire research literature, and easier research discoverability.
...
* **Accessibility, user-friendliness, and dissemination**.
  ...
  * Corresponding practices such as the active use of platform-independent text formatting (i.e. via markdown), the provision of well-formed document structures via clearly-labeled headings, paragraphs, etc., and a pro-active assignment of alt-texts for images and descriptive information for graphs, videos, etc. does not only help making information machine-readable, which is needed for properly disseminating information via the semantic web, but also has the added benefit of making this information accessible for people with access needs (see e.g. the basic accessibility guidelines provided by [UK Home Office Digital](https://github.com/UKHomeOffice/posters/blob/master/accessibility/dos-donts/posters_en-UK/accessibility-posters-set.pdf)).    
...
* **Barriers to Open Access adoption**:
  ...
  * Lack of disributed article-processing charge funding;

  * Wide application of high and unsustainable APCs, which are particularly discriminatory against specific demographics who might lack appropriate funds;
  ...
  * Awareness that around [70% of journals indexed in the DOAJ](https://sustainingknowledgecommons.org/2018/02/06/doaj-apc-information-as-of-jan-31-2018/) do not charge article processing charges;
...
* **Resistance to change**:
  ...
  * It is important to make sure that people can still do what they are already doing, even if they participate in Open Scholarship.

  * *Therefore, future communication efforts must focus on Open practices not being completely new, but simply more efficient and more rewarding versions of current practices.*
