...
* Establish and foster practices of re-use and remix by, among other things,
   ...
   * helping answer questions in [Ask Open Science](https://ask-open-science.org/), [Stack Overflow](https://stackoverflow.com/) and on Twitter,

   * reacting positively to requests for open review.
...
* Locate Open Scholarship hotspots (i.e., venues or groups for regular exchange and discussion about community building) and find a way to link them together to help community cohesion and expansion.
  ...
  * Start discussions towards an implicit or explicit (shared) open science pledge or code of conduct for your department, lab, etc.
