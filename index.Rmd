...
* Make one's own contributions to 'openness' visible in public (e.g., on a CV, open platform, or personal website).
...
* Refuse to engage with publishers that '[double dip](http://www.rluk.ac.uk/about-us/blog/the-costs-of-double-dipping/)' on payments, and demand transparency and data in cases where there is a suspicion that this is occuring. 
...
* Sector-wide adoption of no-questions-asked fee waiver policies for researchers from lower- to middle-income countries, or those with a demonstable financial need.
