...
[Kramer, Bianca, & Bosman, Jeroen (2018, January). Rainbow of open science practices. Zenodo](http://doi.org/10.5281/zenodo.1147024). (CCBY)
...
* For research institutes that currently lack them, either launch and maintain an Open Access repository or find an existing resource to use, and adopt an [Open Access policy](https://cyber.harvard.edu/hoap/Good_practices_for_university_open-access_policies). Make these easily discoverable and accessible on the institutional website, and any relevant indexing services.
   * Examples of Open Access policies can be found e.g. via the [ROARMAP](http://roarmap.eprints.org/cgi/search/advanced)
...
[Tony Ross-Hellauer (2014). Principles of Open Scholarship. Slideshare](https://www.slideshare.net/OpenAIRE_eu/peer-review-in-the-age-of-open-science). (CC BY).
...
* Repository services (e.g., [COAR](https://www.coar-repositories.org/) and [OpenDOAR](http://v2.sherpa.ac.uk/opendoar/));
